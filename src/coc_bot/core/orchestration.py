...
def run_attack(cfg: dict, stop_event: threading.Event, log: LogCallback) -> None:
    ...
    attack_session.run_attack_session(
        ...
        research_every=int(cfg.get("research_every", 0)),
        after_attack_file=cfg.get("after_attack_file") or None,
        upgrades_config=cfg.get("upgrades_config") or None,
        research_config=cfg.get("research_config") or None,
        log_callback=log,
